...
Cell- and exposure-specific DNA methylation changes in response to cigarette smoking indicate shared carcinogenic mechanisms with e-cigarette use
\vspace{1em}
...
\includegraphics[trim = 0 11cm 0 0]{1-figure-panels/SFigure_1_buccalEWAS.pdf}
...
\includegraphics[trim = 0 11cm 0 0]{1-figure-panels/SFigure_3_bloodEWAS.pdf}
...
\includegraphics[trim = 0 11cm 0 0]{1-figure-panels/SFigure_2_cervicalEWAS.pdf}
...
grDevices::cairo_pdf("2-markdown/1-figure-panels/s5a.pdf", width = 5, height = 5)
print(a)
dev.off()
...
grDevices::cairo_pdf("2-markdown/1-figure-panels/s5b.pdf", width = 4, height = 8)
print(b)
dev.off()
...
# 
# # b: expression ---------------------------
load(here("1-analysis-pipeline", "9-output", "expression.Rdata"))
...
grDevices::cairo_pdf("2-markdown/1-figure-panels/ext6b.pdf", width = 6.5, height = 5)
print(ext6b)
dev.off()
...
grDevices::cairo_pdf("2-markdown/1-figure-panels/ext6c.pdf", width = 6.5, height = 5)
print(ext6c)
dev.off()
...
grDevices::cairo_pdf("2-markdown/1-figure-panels/SFigure_6_pcgt.pdf", width = 11, height = 13)
print(plot)
dev.off()
```

\includegraphics{1-figure-panels/SFigure_6_pcgt.pdf}
...
# 
# grDevices::cairo_pdf("2-markdown/1-figure-panels/SFigure_4_celltypes.pdf",
#                      width = 10, height = 11)
# print(plot)
# dev.off()
```

\includegraphics{1-figure-panels/SFigure_4_celltypes.pdf}
...
<!-- \invisiblesection{Supplementary Figure 6. Delta beta density values across cell types and samples in the discovery set.} -->
...
<!-- #  -->
<!-- # grDevices::cairo_pdf("2-markdown/1-figure-panels/SFigure_6_mean.pdf", -->
<!-- #        width = 10, height = 5) -->
<!-- # print(plot) -->
<!-- # dev.off() -->
<!-- ``` -->

<!-- \includegraphics{1-figure-panels/SFigure_6_mean.pdf} -->

<!-- \textbf{Supplementary Figure 6. Delta beta density values across cell types and samples in the discovery set. a} Delta beta in immune and epithelial cells in buccal samples. \textbf{b} Delta beta in immune and epithelial cells in cervical samples. \textbf{c} Delta beta in lymphoid and myeloid cells in blood samples.  -->
...
#   ylab("mean β\n(uncorrected)")
# 
# grDevices::cairo_pdf("2-markdown/1-figure-panels/ext8a.pdf", width = 5, height = 5)
# print(ext8a)
# dev.off()
# 
# dat2 <- dat |>
...
#   ylab("mean β\n(corrected)")
# 
# grDevices::cairo_pdf("2-markdown/1-figure-panels/ext8b.pdf", width = 5, height = 5)
# print(ext8b)
# dev.off()
# 
# # Raw values
...
#   ylab("mean β\n(uncorrected)")
# 
# grDevices::cairo_pdf("2-markdown/1-figure-panels/ext8c.pdf", width = 12, height = 3.75)
# print(ext8c)
# dev.off()
# 
# 
...
#   ylab("mean β\n(corrected)")
# 
# grDevices::cairo_pdf("2-markdown/1-figure-panels/ext8d.pdf", width = 12, height = 3.75)
# print(ext8d)
# dev.off()
```

\includegraphics[trim = 0 10cm 0 0]{1-figure-panels/SFigure_8_correction.pdf}
...
\invisiblesection{Supplementary Figure 9. Animation of correction.}

\textbf{Supplementary Figure 9. Animation of correction.} 

See .mp4 file.

\newpage

\invisiblesection{Supplementary Figure 10. Correlation of corrected mean beta values with smoking pack years in the validation set (buccal and blood samples).}
...
# 
# grDevices::cairo_pdf("2-markdown/1-figure-panels/ext9a.pdf", width = 9, height = 3.5)
# print(a)
# dev.off()
# 
# # Fig b-------------------------
...
# 
# grDevices::cairo_pdf("2-markdown/1-figure-panels/ext9b.pdf", width = 9, height = 3.5)
# print(b)
# dev.off()
# 
# plot <- (a/b) + plot_annotation(tag_levels = "a")
# grDevices::cairo_pdf("2-markdown/1-figure-panels/SFigure_9_spy.pdf", width = 9, height = 7)
# print(plot)
# dev.off()
```

\includegraphics{1-figure-panels/SFigure_9_spy.pdf}

\textbf{Supplementary Figure 10. Correlation of corrected mean beta values with smoking pack years (buccal and blood samples).} For buccal and blood samples, smoking pack year information was available. \textbf{a} Pearson correlation of corrected mean beta values of the four groups of CpGs with smoking pack years in buccal samples. \textbf{b} Pearson correlation of corrected mean beta values of the four groups of CpGs with smoking pack years in buccal samples.
 
\newpage

\invisiblesection{Supplementary Figure 11. E-cigarette dataset raw and corrected methylation values and correlation of corrected scores with cigarette and e-cigarette use.}
...
# 
# grDevices::cairo_pdf("2-markdown/1-figure-panels/SFigure_10_ecig.pdf", width = 10, height = 12)
# print(plot)
# dev.off()
```

\includegraphics{1-figure-panels/SFigure_10_ecig.pdf}
...
\invisiblesection{Supplementary Figure 12. E-cigarette differential methylation at individual loci and gene set enrichment.}

```{r extfig11-ecig-heatmap}
# # Load with smk cpgs
...
#                                    colors = rev(cols2)))
# 
# grDevices::cairo_pdf("2-markdown/1-figure-panels/ext11a.pdf", width = 10, height = 2)
# print(a)
# dev.off()
# 
# # Enrichment ---------------
# load("1-analysis-pipeline/8-output/epi_hypo_GO.Rdata")
# load("1-analysis-pipeline/8-output/prox_epi_hyper_GO.Rdata")
# 
# 
...
#                      circular = F)
# 
# grDevices::pdf("2-markdown/1-figure-panels/ext11b.pdf", width = 6, height = 7)
# print(b)
# dev.off()
# 
...
#                      circular = F)
# 
# grDevices::pdf("2-markdown/1-figure-panels/ext11c.pdf", width = 6, height = 7)
# print(c)
# dev.off()
```

\includegraphics[trim = 0 12cm 0 0]{1-figure-panels/SFigure_11_ecig_enrich.pdf}


\textbf{Supplementary Figure 12. E-cigarette differential methylation at individual loci and gene set enrichment. a} Heatmap comparing delta beta values in the inferred immune and epithelial fractions in buccal samples of the discovery set and e-cigarette users. \textbf{b} Reactome pathway enrichment for sites sharing the same directionality in the epithelial fraction of epithelial hypoM as in smokers in the discovery set. \textbf{c} Reactome pathway enrichment for sites sharing the same directionality in the epithelial fraction of proximal epithelial hyperM as in smokers in the discovery set.


\invisiblesection{Supplementary Figure 13. Smokeless tobacco use dataset raw and corrected methylation values.}

```{r extfig12-smokeless}
# load("1-analysis-pipeline/4-datasets/1-output/snuff_tobacco.Rdata")
# 
# dat <- pheno |>
...
# plot <- ((a)/(b)) + plot_annotation(tag_levels = "a")
# 
# grDevices::cairo_pdf("2-markdown/1-figure-panels/SFigure_12_smokelesstobacco.pdf", width = 10, height = 6)
# print(plot)
# dev.off()
```

\includegraphics{1-figure-panels/SFigure_12_smokelesstobacco.pdf}

\textbf{Supplementary Figure 13. Smokeless tobacco use dataset raw and corrected methylation values. a} Raw methylation mean beta values for each set of CpGs. \textbf{b} Corrected methylation mean beta values in the same samples. 

\invisiblesection{Supplementary Figure 14. Dependence of mean methylation values on immune cell composition in cancer tissue and carcinoma in situ lesions.}
...
# 
# grDevices::cairo_pdf(here("2-markdown/1-figure-panels/SFigure_13_tcga_ic.pdf"),
#                      width = 10, height = 16)
# print(plot)
# dev.off()
```

\includegraphics[width=0.8\textwidth, trim=0 1cm 0 0]{1-figure-panels/SFigure_13_tcga_ic.pdf}

\textbf{Supplementary Figure 14. Dependence of mean methylation values on immune cell composition in cancer tissue and carcinoma in situ lesions.  a} Raw methylation mean beta values for each set of CpGs versus inferred immune cell proportion in TCGA-LUAD and TCGA-LUSC samples with matched control tissue. \textbf{b} Raw methylation mean beta values for each set of CpGs versus inferred immune cell proportion in cervical cancer versus normal control tissue. \textbf{c} Raw methylation mean beta values for each set of CpGs in control samples or regressing or progressing CIS lesions.
...
t9 |>
  gtsave("2-markdown/1-figure-panels/s-table-9.html")

pagedown::chrome_print("2-markdown/1-figure-panels/s-table-9.html", output = "2-markdown/1-figure-panels/s-table-9.pdf")
```
...
t10 |>
  gtsave("2-markdown/1-figure-panels/s-table-10.html")

pagedown::chrome_print("2-markdown/1-figure-panels/s-table-10.html", output = "2-markdown/1-figure-panels/s-table-10.pdf")
```
