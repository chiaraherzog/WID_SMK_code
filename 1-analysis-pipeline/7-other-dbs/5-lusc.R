...
data <- tcga_data |> 
  dplyr::filter(smoking_history != "Unknown" & project == "TCGA-LUSC")

load("~/Documents/Work/data.nosync/tcga_sola/TCGA-LUSC/beta.Rdata")
...
dir <- "~/Dropbox/index-dev/SMK-index/16-manuscript/WID_SMK_code/1-analysis-pipeline/7-other-dbs/5-output/"
