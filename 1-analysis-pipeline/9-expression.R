...
here::i_am("1-analysis-pipeline/9-expression.R")
...
save(df, file = "1-analysis-pipeline/9-output/expression.Rdata")

df |> 
  writexl::write_xlsx(path = here("2-markdown", "Suppl_Table_7_expression.xlsx"))
