...
save(epi_hypo_bp, epi_hypo_cc, epi_hypo_mf, epi_hypo_react_all, file = "1-analysis-pipeline/8-output/epi_hypo_GO.Rdata")
...
save(prox_epi_hyper_bp, prox_epi_hyper_cc, prox_epi_hyper_mf, prox_epi_hyper_react_all, file = "1-analysis-pipeline/8-output/prox_epi_hyper_GO.Rdata")

# Write tables
files <- c("1-analysis-pipeline/8-output/epi_hypo_GO.Rdata",
           "1-analysis-pipeline/8-output/prox_epi_hyper_GO.Rdata")
...
for (i in files){
  ...
  for (v in vars){
    ...
    xlsx::write.xlsx2(get(v), file = paste0("1-analysis-pipeline/8-output/", filename, ".xlsx"),
